        ...
        <div className="grid gap-24 lg:grid-cols-[1fr_1.2fr]">
          ...
          <div className="flex flex-col gap-12">
            <div className="flex flex-col gap-6">
              <span className="font-display text-[10px] font-bold uppercase tracking-[0.4em] text-[#111111]/30">
                Vendor Network
              </span>
              <h1 className="font-display text-6xl font-medium leading-[0.9] tracking-tighter text-[#111111] sm:text-7xl lg:text-9xl">
                Elevate <br />
                Your <br />
                Craft.
              </h1>
            ...
            <div className="flex flex-col gap-8 max-w-sm">
              <p className="font-ui text-lg leading-relaxed text-[#111111]/60">
              ...
              <div className="h-px w-24 bg-[#111111]/10" />
          ...
          <div className="flex flex-col gap-16">
            <div className="flex items-center gap-4">
              ...
              <span className="font-display text-[10px] font-bold uppercase tracking-[0.4em] text-[#111111]">
