               ...
               >
                  ...
                  <div className="flex flex-col gap-3">
                     <div className="flex items-center gap-2 mb-1">
                        <ListChecks className="h-4 w-4 text-[#3A3A3A]" />
                        <span className="font-display text-[10px] font-bold tracking-widest uppercase text-[#3A3A3A]/40">Style Configuration</span>
                     </div>
                     <div className="grid grid-cols-2 gap-3">
                        <div className="bg-[#F9F9F8] border border-[#3A3A3A]/5 rounded-xl p-3 flex flex-col gap-1 hover:border-[#3A3A3A]/20 transition-colors">
                           <span className="font-mono text-[8px] text-zinc-400 tracking-widest uppercase">Collar</span>
                           <span className="font-display text-sm font-medium text-[#3A3A3A]">Mandarin</span>
                        </div>
                        <div className="bg-[#F9F9F8] border border-[#3A3A3A]/5 rounded-xl p-3 flex flex-col gap-1 hover:border-[#3A3A3A]/20 transition-colors">
                           <span className="font-mono text-[8px] text-zinc-400 tracking-widest uppercase">Cuffs</span>
                           <span className="font-display text-sm font-medium text-[#3A3A3A]">French</span>
                        </div>
                        <div className="bg-[#F9F9F8] border border-[#3A3A3A]/5 rounded-xl p-3 flex flex-col gap-1 hover:border-[#3A3A3A]/20 transition-colors">
                           <span className="font-mono text-[8px] text-zinc-400 tracking-widest uppercase">Fit</span>
                           <span className="font-display text-sm font-medium text-[#3A3A3A]">Slim Tailored</span>
                        </div>
                        <div className="bg-[#F9F9F8] border border-[#3A3A3A]/5 rounded-xl p-3 flex flex-col gap-1 hover:border-[#3A3A3A]/20 transition-colors">
                           <span className="font-mono text-[8px] text-zinc-400 tracking-widest uppercase">Placket</span>
                           <span className="font-display text-sm font-medium text-[#3A3A3A]">Hidden</span>
                        </div>
                     </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-3">
                     <div className="flex items-center gap-2 mb-1">
                        <FormInput className="h-4 w-4 text-[#3A3A3A]" />
                        <span className="font-display text-[10px] font-bold tracking-widest uppercase text-[#3A3A3A]/40">Material</span>
                     </div>
                     <div className="flex items-center gap-4 bg-[#F9F9F8] border border-[#3A3A3A]/5 rounded-xl p-3">
                        ...
                        <div className="flex flex-col">
                           <span className="font-display text-sm font-medium text-[#3A3A3A]">Egyptian Cotton Stripe</span>
                  ...
                  <div className="flex flex-col gap-3 flex-1">
                     <div className="flex items-center gap-2 mb-1">
                        <MessageSquare className="h-4 w-4 text-[#3A3A3A]" />
                        <span className="font-display text-[10px] font-bold tracking-widest uppercase text-[#3A3A3A]/40">Customer Notes</span>
                     </div>
