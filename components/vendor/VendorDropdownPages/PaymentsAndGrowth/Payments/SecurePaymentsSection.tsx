            ...
            <div className="relative mx-auto w-full max-w-[500px] rounded-[3rem] bg-[#F9F9F8] border border-[#3A3A3A]/5 shadow-2xl p-6 sm:p-8 overflow-hidden transition-all duration-500 hover:shadow-[0_30px_60px_-12px_rgba(0,0,0,0.25)] hover:-translate-y-2">
               ...
               <div className="flex items-center justify-between pb-5 border-b border-black/5 mb-6">
                  <div className="flex items-center gap-3">
                     ...
                     <span className="font-display text-[10px] font-bold uppercase tracking-widest text-[#3A3A3A]">Payment Security</span>
                  </div>
               ...
               >
                  ...
                  <span className="font-display text-sm font-bold text-[#3A3A3A] uppercase tracking-wider block mb-1">End-to-End Encrypted</span>
                  <span className="font-mono text-[9px] text-[#3A3A3A]/40 uppercase tracking-widest">256-bit SSL · PCI DSS Compliant</span>
               </motion.div>
               ...
               <div className="flex flex-col gap-3 mb-5">
                  ...
                  {PAYMENT_METHODS.map((method, i) => (
                     ...
                     >
                        ...
                        <span className="font-display text-[11px] font-bold text-[#3A3A3A] uppercase tracking-wider flex-1">{method.name}</span>
               ...
               <div className="flex items-center justify-center gap-6 pt-4 border-t border-black/5">
                  <div className="flex items-center gap-2">
                     <Lock className="h-3 w-3 text-[#3A3A3A]/20" />
                     <span className="font-mono text-[8px] font-bold text-[#3A3A3A]/30 uppercase tracking-widest">Escrow Protected</span>
                  </div>
                  <div className="h-3 w-px bg-black/10" />
                  <div className="flex items-center gap-2">
                     <CreditCard className="h-3 w-3 text-[#3A3A3A]/20" />
                     <span className="font-mono text-[8px] font-bold text-[#3A3A3A]/30 uppercase tracking-widest">Instant Processing</span>
                  </div>
               </div>
            </div>
          </div>
