            ...
            <div className="relative mx-auto w-full max-w-[500px] rounded-[3rem] bg-[#F9F9F8] border border-[#3A3A3A]/5 shadow-2xl p-6 sm:p-8 overflow-hidden transition-all duration-500 hover:shadow-[0_30px_60px_-12px_rgba(0,0,0,0.25)] hover:-translate-y-2">
               ...
               <div className="flex items-center justify-between pb-5 border-b border-black/5 mb-6">
                  <div className="flex items-center gap-3">
                     ...
                     <span className="font-display text-[10px] font-bold uppercase tracking-widest text-[#3A3A3A]">Global Reach</span>
                  </div>
               ...
               <div className="grid grid-cols-3 gap-3 mb-6">
                  {[
                     ...
                     >
                        <span className="font-display text-lg font-bold text-[#3A3A3A] block">{stat.value}</span>
                        <span className="font-mono text-[7px] font-bold text-[#3A3A3A]/30 uppercase tracking-widest">{stat.label}</span>
                     </motion.div>
                  ))}
               </div>
                  ...
                  {REGIONS.map((region, i) => (
                     ...
                     >
                        ...
                        <div className="flex-1 flex flex-col gap-0.5">
                           <span className="font-display text-[10px] font-bold text-[#3A3A3A] uppercase tracking-wider">{region.name}</span>
                           <div className="flex items-center gap-1.5">
                              <MapPin className="h-2.5 w-2.5 text-[#3A3A3A]/20" />
                              <span className="font-mono text-[8px] text-[#3A3A3A]/40 uppercase tracking-widest">Active</span>
                           </div>
                        </div>
                        <div className="flex items-center gap-1.5">
                           <Package className="h-3 w-3 text-[#3A3A3A]/20" />
                           <span className="font-mono text-[9px] font-bold text-[#3A3A3A]/60">{region.orders}</span>
                        </div>
                     </motion.div>
                  ))}
               </div>
