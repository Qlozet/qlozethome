            ...
            <div className="relative mx-auto w-full max-w-[500px] rounded-[3rem] bg-zinc-50 border border-black/5 shadow-2xl p-6 sm:p-8 overflow-hidden transition-all duration-500 hover:shadow-[0_30px_60px_-12px_rgba(0,0,0,0.25)] hover:-translate-y-2">
               ...
               <div className="flex items-center justify-between pb-5 border-b border-black/5 mb-6">
                  <div className="flex items-center gap-3">
                     ...
                     <span className="font-display text-[10px] font-bold uppercase tracking-widest text-black">Growth Engine</span>
                  </div>
               ...
               <div className="flex flex-col gap-3 mb-6">
                  {GROWTH_METRICS.map((metric, i) => {
                     ...
                     return (
                        ...
                        >
                           <div className="h-12 w-12 rounded-xl bg-zinc-50 border border-black/5 flex items-center justify-center shrink-0">
                              <Icon className="h-5 w-5 text-black/40" />
                           </div>
                           <div className="flex-1 flex flex-col gap-1">
                              <span className="font-mono text-[8px] font-bold text-black/40 uppercase tracking-widest">{metric.label}</span>
                              <span className="font-display text-xl font-bold text-black tracking-tight">{metric.value}</span>
                           </div>
               ...
               >
                  <div className="flex items-center justify-between mb-3">
                     <span className="font-mono text-[8px] font-bold text-black/40 uppercase tracking-widest">Customer Growth</span>
