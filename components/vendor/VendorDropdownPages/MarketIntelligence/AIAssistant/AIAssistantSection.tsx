...
export function AIAssistantSection({ data }: AssistantSectionProps) {
  return (
    <section className="relative z-30 bg-brand-darker px-6 md:px-10 lg:px-10 py-24 sm:py-32 overflow-hidden" data-theme="dark">
              ...
              {data.features.map((feature, i) => {
                ...
                return (
                  <div key={i} className="flex items-center gap-4 group">
                    <div className="h-9 w-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white group-hover:bg-brand-light group-hover:text-brand-darker transition-all">
            ...
            <div className="flex items-center justify-between pb-5 border-b border-white/5 mb-6">
              <div className="flex items-center gap-3">
                <motion.div animate={{ rotate: [0, 360] }} transition={{ duration: 8, repeat: Infinity, ease: "linear" }}
                  className="h-8 w-8 rounded-xl bg-brand-light text-brand-darker flex items-center justify-center">
