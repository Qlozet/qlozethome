...
type VendorClosingSectionProps = {
  data: ClosingData;
};

export function VendorClosingSection({ data }: VendorClosingSectionProps) {
  return (
    <section className="relative overflow-hidden bg-white py-24 sm:py-32" data-theme="light">
      <div className="mx-auto max-w-[94rem] px-6 md:px-10 lg:px-10">
        <div className="relative overflow-hidden rounded-[4rem] bg-brand-darker p-12 lg:p-32 shadow-3xl">
          ...
          <div className="relative z-10 flex flex-col items-center text-center gap-12 lg:gap-16">
            ...
            >
              <Link 
                ...
                className="group relative inline-flex h-16 items-center justify-center overflow-hidden rounded-full bg-white px-12 text-[11px] font-bold uppercase tracking-[0.35em] text-brand-darker transition-all hover:scale-[1.05] active:scale-95 shadow-3xl"
              >
          ...
          {/* Decorative Production Line End */}
