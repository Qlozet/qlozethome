      ...
      <div className="mx-auto max-w-[94rem] px-6 md:px-10 lg:px-10">
        <div className="flex flex-col gap-16 lg:flex-row-reverse lg:items-center lg:gap-24">
          ...
          <div className="relative lg:w-1/2 order-2 lg:order-1 flex items-center justify-center">
             <div className="relative h-[480px] lg:h-[580px] w-full max-w-md rounded-[3rem] bg-brand-light border border-brand-darker/5 shadow-2xl overflow-hidden flex items-center justify-center">
                ...
                <svg className="absolute inset-0 h-full w-full pointer-events-none opacity-[0.15]">
                   <motion.path 
                      ...
                      stroke="#1e1008" strokeWidth="1" fill="none" strokeDasharray="4 4"
                ...
                <div className="absolute inset-0 pointer-events-none">
                   ...
                   >
                      <div className="h-6 w-6 rounded-lg bg-white border border-brand-darker/10 shadow-lg flex items-center justify-center">
                         <Globe className="h-3 w-3 text-brand-darker/40" />
                      </div>
                   </motion.div>
                </div>

                {/* Partner Network Marquee (Bottom overlaid) */}
                <div className="absolute bottom-16 inset-x-0 overflow-hidden bg-white/50 backdrop-blur-md border-y border-brand-darker/5 py-3">
