      ...
      >
        <div className="flex flex-col gap-16 lg:flex-row lg:items-center lg:gap-24">
          ...
          <div className="relative lg:w-1/2 flex items-center justify-center px-4">
             <div className="relative h-[450px] lg:h-[550px] w-full max-w-md rounded-[3rem] bg-zinc-50 border border-black/5 shadow-2xl p-10 flex flex-col gap-10 overflow-hidden group">
                ...
                <div className="flex items-center justify-between border-b border-black/5 pb-8 relative z-10">
                   <div className="flex items-center gap-4">
                      <div className="h-8 w-8 flex items-center justify-center rounded-xl bg-black text-white shadow-xl shadow-black/10">
                         <Navigation className="h-4 w-4" />
                      </div>
                      <span className="font-display text-[10px] font-bold uppercase tracking-widest text-black">Live Tracking Engine</span>
                   </div>
                   <div className="flex items-center gap-2">
                       ...
                       <span className="font-display text-[8px] font-bold uppercase tracking-widest text-black/50">Active Flow</span>
                   </div>
                </div>
                ...
                <div className="flex flex-col gap-12 flex-1 justify-center relative py-10 z-10">
                   ...
                   <div className="absolute left-6 top-0 bottom-0 w-px bg-black opacity-[0.05]" />
                   ...
                   <div className="absolute left-6 top-0 bottom-0 w-px overflow-hidden">
                      <motion.div 
                         ...
                         className="h-24 w-full bg-gradient-to-b from-transparent via-black to-transparent opacity-[0.15]"
                      />
                   </div>
                   
                   {[
                      { icon: MapPin, label: "01: Atelier Pickup", desc: "Creator Verified", id: 'pickup', color: 'text-black' },
                      { icon: Truck, label: "02: Hub Transit", desc: "Batch Distro", id: 'transit', color: 'text-zinc-600' },
                      { icon: ArrowUpRight, label: "03: Client Drop", desc: "Last Mile", id: 'final', color: 'text-zinc-400' },
                   ].map((step, i) => (
                      <motion.div 
                        key={step.id} 
                        initial={{ opacity: 0.2 }}
                      ...
                      >
                         ...
                         <div className="flex flex-col gap-0.5 pt-1 min-w-0">
                            ...
                            <span className="font-ui text-[10px] lg:text-[11px] text-black/40 group-hover/step:text-black/70 transition-colors whitespace-nowrap">{step.desc}</span>
                         </div>
                         ...
                         {i === 0 && (
                            <motion.div 
                               ...
                               className="absolute left-6 -translate-x-1/2 h-3.5 w-3.5 bg-black rounded-full shadow-[0_0_15px_rgba(0,0,0,0.3)] z-30 ring-4 ring-white"
                            />
                         )}
                      </motion.div>
                   ))}
                ...
                <div className="absolute inset-0 pointer-events-none z-20">
                    <motion.div 
                       ...
                       className="h-px w-full bg-gradient-to-r from-transparent via-black/10 to-transparent shadow-[0_0_20px_rgba(0,0,0,0.05)]"
                    />
                </div>
             </div>
          </div>
