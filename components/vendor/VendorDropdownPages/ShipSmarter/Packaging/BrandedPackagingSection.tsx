      ...
      <div className="mx-auto max-w-[94rem] px-6 md:px-10 lg:px-10">
        <div className="flex flex-col gap-16 lg:flex-row-reverse lg:items-center lg:gap-24">
          ...
          <div className="relative lg:w-1/2 flex items-center justify-center">
             <div className="relative h-[480px] lg:h-[580px] w-full max-w-md rounded-[3rem] bg-brand-light border border-brand-darker/5 shadow-2xl overflow-hidden flex flex-col items-center justify-center group">
                ...
                <div className="relative h-80 w-80 perspective-[1000px] flex items-center justify-center">
                   ...
                   <motion.div 
                      ...
                      className="absolute h-48 w-48 bg-white rounded-xl border border-brand-darker/10 shadow-[0_40px_50px_-12px_rgba(0,0,0,0.1)] flex items-center justify-center transform-style-3d"
                   >
                      ...
                      <motion.div 
                         ...
                         className="absolute inset-4 bg-brand-light border border-brand-darker/5 flex items-center justify-center"
                      >
                         {/* Clothing Item / Content placeholder */}
                         <div className="h-20 w-20 bg-brand/20 rounded-md opacity-50" />
                      </motion.div>
                   </motion.div>
                   ...
                   >
                      ...
                      {/* Inner Lid Texture */}
                      <div className="absolute inset-0 border-[12px] border-brand/50 rounded-xl pointer-events-none" />
                   </motion.div>
                   ...
                   <motion.div 
                      ...
                      className="absolute top-10 left-0 bg-white/90 backdrop-blur-md px-3 py-2 rounded-lg shadow-xl border border-brand-darker/5 flex items-center gap-2"
                   >
                      <div className="h-1.5 w-1.5 rounded-full bg-brand-darker animate-pulse" />
                      <span className="font-display text-[8px] font-bold uppercase tracking-widest text-brand-darker/60">Premium Seal</span>
                   </motion.div>
                   ...
                   <motion.div 
                      ...
                      className="absolute bottom-10 right-0 bg-white/90 backdrop-blur-md px-3 py-2 rounded-lg shadow-xl border border-brand-darker/5 flex items-center gap-2"
                   >
                      <CheckCircle2 className="h-3 w-3 text-brand-darker" />
                      <span className="font-display text-[8px] font-bold uppercase tracking-widest text-brand-darker/60">Bespoke Wrapping</span>
                   </motion.div>
                </div>
 
                {/* Footer Statement */}
                <div className="absolute bottom-10 w-full text-center">
                   <p className="font-display text-[10px] font-bold text-brand-darker/30 uppercase tracking-[0.4em]">The Unboxing Experience</p>
                </div>
             </div>
          </div>
        </div>
