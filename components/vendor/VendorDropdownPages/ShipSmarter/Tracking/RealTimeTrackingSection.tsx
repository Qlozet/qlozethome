      ...
      <div className="mx-auto max-w-[94rem] px-6 md:px-10 lg:px-10">
        <div className="flex flex-col gap-16 lg:flex-row lg:items-center lg:gap-24">
          ...
          <div className="relative lg:w-1/2">
             <div className="relative mx-auto h-[480px] lg:h-[580px] w-full max-w-md rounded-[3rem] bg-brand-light border border-brand-darker/5 shadow-2xl overflow-hidden transform items-center justify-center">
                
                {/* Minimalist Map Background */}
                <div className="absolute inset-0 bg-brand-light">
                   <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(circle at 2px 2px, #1e1008 1px, transparent 0)', backgroundSize: '16px 16px' }} />
                   
                   {/* Abstract Street Lines */}
                   <svg className="absolute inset-0 h-full w-full opacity-5 pointer-events-none">
                      <path d="M -50,50 L 300,400 M 100,-50 L 400,250 M -50,300 L 450,150 M -50,150 L 250,-50 M 200,550 L 450,300" stroke="#1e1008" strokeWidth="20" fill="none" />
                   </svg>
                </div>
                ...
                <svg className="absolute inset-0 h-full w-full pointer-events-none z-10" preserveAspectRatio="none">
                   {/* Route Shadow/Glow */}
                   <path id="routePath" d="M 50,450 Q 80,300 150,250 T 250,150 T 350,50" stroke="#1e1008" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" fill="none" className="opacity-[0.05]" />
                   {/* Active Route Line */}
                   <motion.path 
                      d="M 50,450 Q 80,300 150,250 T 250,150 T 350,50" 
                      stroke="#1e1008" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="none" 
                ...
                <div className="absolute inset-0 z-20 pointer-events-none">
                   ...
                   <div className="absolute top-[450px] left-[50px] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-1">
                      <div className="h-4 w-4 bg-white border-2 border-brand-darker rounded-full shadow-lg" />
                   </div>
                   
                   {/* Destination Pin */}
                   <div className="absolute top-[50px] left-[350px] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-1">
                      <div className="h-6 w-6 bg-brand-darker rounded-full shadow-xl flex items-center justify-center">
                   ...
                   >
                      <div className="absolute inset-0 bg-brand-darker/10 rounded-full blur-xl scale-150 animate-pulse" />
                      <div className="h-10 w-10 bg-white shadow-2xl rounded-2xl flex items-center justify-center border border-brand-darker/10 relative">
                         <div className="absolute -inset-2 border-2 border-brand-darker/10 rounded-[1.25rem] animate-ping opacity-20" />
                         <Truck className="h-5 w-5 text-brand-darker" fill="#1e1008" />
                      </div>
                   </motion.div>
                </div>
                ...
                <motion.div 
                   ...
                   whileInView={{ opacity: 1, y: 0 }}
                   transition={{ delay: 1 }}
                   className="absolute top-6 left-6 z-40 bg-white/90 backdrop-blur-xl border border-brand-darker/5 shadow-2xl p-4 rounded-3xl w-48"
                >
                      ...
                      <div className="flex flex-col gap-1.5">
                         <div className="h-1.5 w-full bg-brand-light rounded-full overflow-hidden">
                            <motion.div 
                               ...
                               animate={{ width: "60%" }}
                               transition={{ duration: 4, ease: "easeOut" }}
                               className="h-full bg-brand-darker"
                            />
                         </div>
                ...
                <motion.div 
                   ...
                   className="absolute bottom-6 inset-x-6 z-40 bg-brand-darker text-white shadow-2xl p-5 rounded-[2rem] border border-white/10"
                >
