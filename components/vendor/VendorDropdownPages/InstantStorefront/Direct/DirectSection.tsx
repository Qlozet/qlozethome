      ...
      <div className="mx-auto max-w-[94rem] px-6 md:px-10 lg:px-10">
        <div className="flex flex-col gap-10 lg:flex-row lg:items-center">
          ...
          <div className="flex flex-col gap-12 lg:w-1/2">
            ...
            <div className="flex flex-col gap-6">
              {data.features.map((feature, index) => (
                ...
                >
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-brand-light border border-brand-darker/5 transition-all group-hover:bg-brand-darker group-hover:text-white">
                    {(() => {
                        const Icon = iconMap[feature] || MessageSquare;
                        return <Icon className="h-5 w-5" strokeWidth={1.5} />;
                    })()}
                  </div>
                  <span className="font-ui text-lg font-medium text-[#111111]/70 group-hover:text-[#111111]">
                    {feature}
                  </span>
                </motion.div>
              ))}
          ...
          <div className="lg:w-1/2 flex justify-center items-center">
             <div className="relative w-full max-w-md p-6 sm:p-10 bg-brand-light rounded-[2rem] sm:rounded-[3rem] border border-brand-darker/5 shadow-xl overflow-hidden group">
                <div className="flex flex-col gap-6 relative z-10">
                   ...
                   >
                     <span className="font-ui text-sm text-[#111111]/60">Can I customize the sleeves on this piece?</span>
                   </motion.div>
                   ...
                   <motion.div
                     ...
                     whileInView={{ opacity: 1, x: 0 }}
                     transition={{ delay: 0.2 }}
                     className="bg-brand-darker rounded-3xl p-6 shadow-xl w-4/5 self-end"
                   >
