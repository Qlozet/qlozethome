...
export function ClosingSection({ data }: ClosingSectionProps) {
  return (
    <section className="relative w-full bg-white py-24 lg:py-48 overflow-hidden" data-theme="light">
      ...
      {/* Decorative Accents */}
      <div className="absolute top-1/2 left-0 w-64 h-px bg-black opacity-10 hidden lg:block" />
      <div className="absolute top-1/2 right-0 w-64 h-px bg-black opacity-10 hidden lg:block" />
    </section>
  );
}
