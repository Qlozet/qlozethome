        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:gap-20">
          ...
          >
            <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[3rem] bg-zinc-100 shadow-2xl shadow-black/10">
              <Image
                src="/image/managesteps-hero.png"
                alt="Production Management Interface"
                fill
            ...
            >
              <div className="flex flex-col gap-2">
                <span className="font-display text-[9px] font-bold uppercase tracking-[0.3em] text-black/30">Order Control</span>
                <span className="font-display text-xl font-medium text-black">Perfect Pulse</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
