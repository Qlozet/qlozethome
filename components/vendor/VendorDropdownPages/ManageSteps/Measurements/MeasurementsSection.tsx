...
import { Ruler, FileText, SwatchBook, ScissorsSquare } from "lucide-react";
...
export function MeasurementsSection({ data }: MeasurementsSectionProps) {
      ...
      >
        ...
        <div className="lg:sticky lg:top-40 lg:w-5/12">
          <div className="flex flex-col gap-8">
             ...
             >
               <ScissorsSquare className="h-8 w-8 text-white/40" strokeWidth={1} />
             </motion.div>
