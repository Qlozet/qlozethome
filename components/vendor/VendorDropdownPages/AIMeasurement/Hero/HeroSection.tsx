...
type HeroSectionData = typeof import("@/data/vendor/vendordropdown/aimmeasurement/hero.json");
          ...
          <div className="flex flex-col gap-12 lg:w-3/5 lg:pt-20">
            <div className="flex flex-col gap-8">
              ...
              <div className="relative">
                <motion.h1
                  variants={itemVariants}
                  className="relative z-10 max-w-3xl font-display text-5xl font-medium leading-[1.05] tracking-tighter text-black sm:text-7xl lg:text-[5.5rem]"
                >
                  {data.title}
                </motion.h1>
                {/* Visual Accent */}
          ...
          >
            ...
            >
              <div className="flex flex-col gap-2">
                <span className="font-display text-[9px] font-bold uppercase tracking-[0.3em] text-black/30">Validation</span>
                <span className="font-display text-xl font-medium text-black">Lock Specs</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
