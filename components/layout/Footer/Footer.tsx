              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:gap-0 sm:max-w-sm sm:overflow-hidden sm:rounded-full sm:border sm:border-white/10 sm:bg-white/5 sm:p-1 sm:backdrop-blur-sm transition-all sm:focus-within:border-white/20 sm:focus-within:bg-white/10">
                  <input
                    ...
                    className="w-full rounded-full border border-white/10 bg-white/5 px-6 py-4 font-ui text-sm text-white placeholder-white/30 outline-none transition-all focus:border-white/20 sm:w-auto sm:flex-1 sm:border-none sm:bg-transparent sm:py-3 sm:focus:border-none"
                  />
                  <button className="w-full rounded-full bg-white px-6 py-4 font-ui text-xs font-semibold uppercase tracking-widest text-[#3A3A3A] transition-all hover:bg-neutral-100 active:scale-[0.98] sm:w-auto sm:py-3">
                    Join
                  </button>
                </div>
              </div>
