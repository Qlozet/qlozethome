...
export function WhatsCustomizeSection({ data }: WhatsCustomizeSectionProps) {
  return (
    <section className="relative z-10 -mt-[200px] sm:-mt-[100px] rounded-t-[30px] sm:rounded-t-[5rem] bg-white px-6  pb-[200px] sm:pb-[200px] py-16 sm:py-24">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {data.items.map((item) => (
            ...
            >
              ...
              {/* Title */}
              <h3 className="mb-3 text-xl font-normal text-black">{item.title}</h3>
