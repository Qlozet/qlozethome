          ...
          <div className="flex flex-col gap-12 order-1 lg:order-2 lg:w-1/2">
            <div className="flex flex-col gap-8">
              <motion.h2
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="font-display text-5xl font-medium leading-[1.05] tracking-tighter text-black sm:text-7xl lg:text-[6.5rem]"
              >
                {data.title}
              </motion.h2>
              <motion.p
            ...
            >
              <Link
                ...
                className="group relative inline-flex h-16 items-center justify-center overflow-hidden rounded-full bg-black px-12 text-[10px] font-bold uppercase tracking-[0.4em] text-white transition-all hover:scale-[1.05] active:scale-95 shadow-2xl shadow-black/20"
              >
