          ...
          <div className="flex flex-col gap-12 order-1 lg:order-2 lg:w-1/2">
            ...
            >
              <Link
                ...
                className="group relative inline-flex h-16 items-center justify-center overflow-hidden rounded-full bg-brand-button px-12 text-[10px] font-bold uppercase tracking-[0.4em] text-white transition-all hover:scale-[1.05] active:scale-95 shadow-2xl shadow-black/20"
              >
