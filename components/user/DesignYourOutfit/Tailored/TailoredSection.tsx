               ...
               <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.5 }}
                     ...
                     <div className="relative">
                        <div className="h-3 w-3 rounded-full bg-black animate-ping absolute" />
                        <div className="h-3 w-3 rounded-full bg-black relative z-10" />
                     </div>
                  </motion.div>
                  <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.7 }}
                     className="absolute top-1/2 left-1/3">
                     <div className="relative">
                        <div className="h-2.5 w-2.5 rounded-full bg-black/60 animate-ping absolute" />
                        <div className="h-2.5 w-2.5 rounded-full bg-black relative z-10" />
                     </div>
                  </motion.div>
               </div>
               ...
               <div className="p-6 sm:p-8 flex flex-col gap-5">
                  <div className="flex items-center justify-between">
                     ...
                     <div className="flex items-center gap-1.5 bg-emerald-500/10 px-3 py-1.5 rounded-full">
                        ...
                        <span className="font-mono text-[8px] font-bold text-emerald-600 uppercase tracking-widest">Synced</span>
                     </div>
                  </div>
