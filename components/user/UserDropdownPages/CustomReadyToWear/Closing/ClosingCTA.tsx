    ...
    <section id={data.id} className="scroll-mt-32 bg-white pt-24 pb-48" data-theme="light">
      <div className="mx-auto max-w-[94rem] px-6 md:px-10 lg:px-10">
        <motion.div 
          ...
          className="relative overflow-hidden rounded-[4rem] bg-brand-darker text-white shadow-3xl min-h-[600px] flex flex-col lg:flex-row lg:items-center"
        >
            ...
            <div className="flex flex-col justify-center gap-12 p-12 sm:p-20 lg:p-32 lg:w-1/2">
              ...
              <motion.div variants={itemVariants} className="flex flex-col gap-4 sm:flex-row sm:items-center">
                <Link
                  ...
                  className="inline-flex h-18 items-center justify-center rounded-full bg-white px-14 py-6 text-xs font-bold uppercase tracking-[0.35em] text-brand-darker transition-all hover:scale-[1.05] active:scale-[0.98] shadow-2xl"
                >
      ...
      <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center">
         <div className="w-4 h-4 rounded-full bg-brand-darker/5 ring-8 ring-black/[0.02]" />
      </div>
    </section>
  );
}
