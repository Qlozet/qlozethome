        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-24">
          ...
          <div className="relative mt-10 lg:mt-0 lg:w-1/2 flex justify-center">
            <motion.div
              ...
              className="w-full max-w-[420px] rounded-3xl bg-white border border-brand-darker/5 shadow-2xl overflow-hidden"
            >
              {/* Console Header */}
              <div className="flex items-center justify-between px-5 py-3 border-b border-brand-darker/5 bg-brand-darker/[0.02]">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-mono text-[8px] font-bold text-[#111111]/30 uppercase tracking-widest">Fit Profile</span>
                </div>
              ...
              {/* Profile Identity */}
              <div className="px-5 pt-5 pb-4 flex items-center gap-4 border-b border-brand-darker/5">
                <motion.div
                  initial={{ scale: 0.8, opacity: 0 }}
                  whileInView={{ scale: 1, opacity: 1 }}
                  viewport={{ once: true }}
                  transition={{ delay: 0.3 }}
                  className="relative h-14 w-14 rounded-2xl overflow-hidden border border-brand-darker/10 shrink-0"
                >
                ...
                <div className="flex flex-col gap-0.5 flex-1 min-w-0">
                  <span className="font-display text-sm font-bold text-[#111111] tracking-tight">Seun Adeyemi</span>
                  <span className="font-mono text-[7px] text-[#111111]/30 font-bold uppercase tracking-widest">Profile ID: SEUN_A • Last Updated: 2 days ago</span>
                </div>
              </div>
              ...
              <div className="px-5 pt-4 pb-2">
                <div className="flex items-center justify-between mb-3">
                  <span className="font-mono text-[7px] font-bold text-[#111111]/25 uppercase tracking-widest">Saved Measurements</span>
                  <span className="font-mono text-[7px] text-[#111111]/15 uppercase tracking-widest">6 Points</span>
                </div>
                <div className="grid grid-cols-3 gap-2">
                  {MEASUREMENTS.map((m, idx) => (
                    <motion.div
                      ...
                      className="rounded-xl bg-zinc-50 border border-brand-darker/5 p-3 flex flex-col gap-1 group hover:bg-brand-darker/[0.04] transition-colors cursor-default"
                    >
                      <span className="font-mono text-[6px] font-bold text-[#111111]/20 uppercase tracking-widest">{m.label}</span>
                      <div className="flex items-baseline gap-0.5">
                        <span className="font-display text-lg font-bold text-[#111111] tracking-tight">{m.value}</span>
                        <span className="font-mono text-[7px] text-[#111111]/25">{m.unit}</span>
                      </div>
                    </motion.div>
                  ))}
                </div>
              ...
              <div className="px-5 pb-5">
                <span className="font-mono text-[7px] font-bold text-[#111111]/20 uppercase tracking-widest block mb-2.5">Recent Fits</span>
                <div className="flex gap-2">
                  {[
                    ...
                    <motion.div
                      ...
                      className="relative flex-1 aspect-[3/4] rounded-xl overflow-hidden border border-brand-darker/5 group cursor-default"
                    >
