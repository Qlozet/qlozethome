            ...
            >
              ...
              <div className="flex items-center justify-between px-5 py-3 border-b border-brand-darker/5 bg-brand-darker/[0.02]">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-mono text-[8px] font-bold text-[#111111]/30 uppercase tracking-widest">Design Studio</span>
                </div>
              ...
              <div className="relative h-56 bg-zinc-50 overflow-hidden">
                ...
                >
                  ...
                  <div className="absolute top-[28%] left-1/2 -translate-x-1/2">
                    ...
                    >
                      <div className="absolute -left-1 -top-1 h-2 w-2 rounded-full bg-white border border-brand-darker/30" />
                      <div className="absolute -right-1 -top-1 h-2 w-2 rounded-full bg-white border border-brand-darker/30" />
                      <span className="absolute -top-5 left-1/2 -translate-x-1/2 font-mono text-[7px] font-bold text-white bg-brand-darker/60 backdrop-blur-sm px-1.5 py-0.5 rounded whitespace-nowrap">42cm</span>
                    </motion.div>
                  </div>
                  ...
                  <div className="absolute top-[30%] right-[18%]">
                    ...
                    >
                      <div className="absolute -top-1 -left-1 h-2 w-2 rounded-full bg-white border border-brand-darker/30" />
                      <div className="absolute -bottom-1 -left-1 h-2 w-2 rounded-full bg-white border border-brand-darker/30" />
                      <span className="absolute top-1/2 -translate-y-1/2 left-3 font-mono text-[7px] font-bold text-white bg-brand-darker/60 backdrop-blur-sm px-1.5 py-0.5 rounded whitespace-nowrap">72cm</span>
                    </motion.div>
                  </div>
                </motion.div>
                ...
                <div className="absolute bottom-3 left-4 z-10">
                  <span className="font-mono text-[7px] text-[#111111]/40 font-bold uppercase tracking-widest">Ref: 7822-Custom</span>
                </div>
              </div>

              {/* Style Specifications */}
              <div className="px-5 pt-4 pb-3">
                <span className="font-mono text-[7px] font-bold text-[#111111]/25 uppercase tracking-widest block mb-3">Style Specs</span>
                <div className="grid grid-cols-2 gap-2">
                  {STYLE_SPECS.map((spec, idx) => (
                    <motion.div
                      ...
                      className="rounded-xl bg-zinc-50 border border-brand-darker/5 p-3 flex flex-col gap-1 group hover:border-brand-darker/15 transition-all cursor-default"
                    >
                      <div className="flex items-center justify-between">
                        <span className="font-mono text-[6px] font-bold text-[#111111]/20 uppercase tracking-widest">{spec.label}</span>
                        {spec.editable && <PencilLine className="h-2.5 w-2.5 text-brand-darker/15 group-hover:text-brand-darker/50 transition-colors" />}
                      </div>
                      <span className="font-display text-[10px] sm:text-[11px] font-bold text-[#111111]/70">{spec.value}</span>
                    </motion.div>
                  ))}
                </div>
              </div>
              ...
              <div className="px-5 pt-2 pb-3">
                <span className="font-mono text-[7px] font-bold text-[#111111]/25 uppercase tracking-widest block mb-3">Fabric</span>
                  ...
                  {FABRICS.map((f, idx) => (
                    <motion.div
                      ...
                      className={`relative flex-1 aspect-[4/3] rounded-xl overflow-hidden cursor-default transition-all duration-300
                        ${f.selected
                          ? 'ring-2 ring-brand-darker ring-offset-1 shadow-md'
                          : 'opacity-50'
                        }`}
                    >
                      ...
                      {f.selected && (
                        <div className="absolute top-1.5 right-1.5 h-4 w-4 rounded-full bg-brand-darker flex items-center justify-center">
              ...
              <div className="px-5 pb-5 pt-2">
                <motion.div
                  ...
                  className="rounded-2xl bg-brand-darker p-4 flex items-center gap-4"
                >
