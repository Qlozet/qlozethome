          ...
          <div className="relative mt-20 lg:mt-0 lg:w-1/2">
             <div className="relative grid grid-cols-2 gap-4">
                ...
                <motion.div 
                  ...
                  className="col-span-2 relative aspect-video w-full rounded-[3rem] bg-white border border-black/5 shadow-2xl p-4 overflow-hidden"
                >
                   <Image 
                     src="/image/packaging-premium.png" 
