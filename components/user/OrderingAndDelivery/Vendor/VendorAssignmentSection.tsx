...
export function VendorAssignmentSection({ data }: VendorAssignmentSectionProps) {
  const skills = [
    ...
    { name: "Precision Cutting", value: 95, color: "bg-emerald-500/60" },
  ];
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:gap-32">
          ...
          <div className="relative mt-20 lg:mt-0 lg:w-1/2 order-1 lg:order-1">
            <motion.div
              ...
              className="relative mx-auto w-full max-w-md p-8 lg:p-12"
            >
              <div className="relative z-10 w-full rounded-[4rem] bg-white shadow-2xl border border-black/5 p-8 flex flex-col gap-10 overflow-hidden transition-all duration-500 hover:shadow-[0_30px_60px_-12px_rgba(0,0,0,0.25)] hover:-translate-y-2">
                {/* Vendor Profile */}
                <div className="flex items-center gap-6">
                  <div className="relative h-20 w-20 rounded-full bg-zinc-900 overflow-hidden flex items-center justify-center border-4 border-white shadow-xl shrink-0">
                    <span className="font-display text-2xl font-bold text-white tracking-tighter">A8</span>
                  </div>
                  <div className="flex flex-col gap-1">
                    <div className="flex items-center gap-2">
                      <span className="font-display text-xl font-bold text-black tracking-tighter italic lg:text-2xl">Atelier 08-D</span>
                ...
                <div className="pt-6 border-t border-black/5 flex items-center justify-between">
                  <div className="flex items-center gap-2 px-4 py-2 rounded-full border border-black/5 bg-zinc-50">
                    ...
                    <span className="font-display text-[10px] font-bold uppercase tracking-[0.2em] text-black">Master Tailor</span>
                  </div>
                  <div className="flex flex-col items-end gap-1">
                    <span className="font-ui text-[9px] text-black/40">Availability</span>
                    <span className="font-display text-[10px] font-bold text-emerald-600 tracking-widest uppercase">Ready</span>
                  </div>
                </div>
              </div>
              ...
              <motion.div
                ...
                className="absolute -top-2 -left-2 z-20 px-5 py-3 bg-emerald-500 text-white rounded-2xl shadow-2xl font-display text-[10px] font-bold uppercase tracking-widest border-4 border-white"
              >
                Best Match
              </motion.div>
            </motion.div>
