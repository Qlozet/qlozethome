...
export function HowItWorksSection({ data }: HowItWorksSectionProps) {
  return (
    <section className="bg-[#3d3d3d] rounded-t-[30px] sm:rounded-t-[5rem] mt-[-250px] sm:-mt-[100px] px-6 py-16 sm:py-24 z-20 relative pb-[200px] sm:pb-[200px]">
