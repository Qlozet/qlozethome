            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
               {data.features.map((feature, index) => {
                 ...
                 return (
                   ...
                   >
                     <div className="h-10 w-10 flex items-center justify-center bg-brand-light border border-brand-darker/5 rounded-xl">
                        <Icon className="h-5 w-5 text-brand-darker" />
                     </div>
