  ...
  return (
    <section className="relative min-h-screen w-full flex items-center justify-center pt-24 pb-12 overflow-hidden" data-theme="light">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:gap-24">
          ...
          <div className="flex flex-col gap-10 lg:w-1/2">
            <div className="flex flex-col gap-6">
              ...
              <motion.h1
                variants={itemVariants}
                className="font-display text-4xl font-medium leading-[1] tracking-tighter text-[#111111] sm:text-6xl lg:text-7xl xl:text-8xl"
              >
                {data.title}
              </motion.h1>
              ...
              <motion.p
                variants={itemVariants}
                className="max-w-xl font-ui text-lg leading-relaxed text-[#111111]/40 sm:text-2xl"
              >
                {data.description}
              </motion.p>
            </div>
            ...
            >
              <Link
                href={data.cta.href}
                className="group relative inline-flex h-16 items-center justify-center gap-4 overflow-hidden rounded-full bg-brand-button hover:bg-brand px-12 text-[11px] font-bold uppercase tracking-[0.35em] text-white transition-all hover:scale-[1.02] active:scale-95 shadow-2xl"
              >
          ...
          <div className="relative mt-20 lg:mt-0 lg:w-1/2">
             <div className="relative mx-auto w-full max-w-[560px] h-[560px] sm:h-[620px]">
                ...
                <motion.div
                   ...
                   className="absolute top-0 left-0 w-[60%] h-[75%] rounded-[2.5rem] overflow-hidden shadow-2xl border border-brand-darker/5 z-20"
                >
                   ...
                   <div className="absolute bottom-5 left-5 right-5">
                      <div className="bg-white/90 backdrop-blur-sm px-4 py-2 rounded-full inline-flex items-center gap-2 shadow-sm">
                         ...
                         <span className="font-mono text-[8px] font-bold text-brand-darker uppercase tracking-widest">New Arrivals</span>
                      </div>
                   </div>
                </motion.div>
                ...
                <motion.div
                   ...
                   className="absolute top-[40%] right-[35%] z-40 bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-brand-darker/5 px-5 py-3 flex items-center gap-3"
                >
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 flex flex-col items-center">
        <div className="w-px h-24 bg-brand-darker/5" />
        <div className="w-2 h-2 rounded-full bg-brand-darker/10" />
      </div>
    </section>
  );
}
