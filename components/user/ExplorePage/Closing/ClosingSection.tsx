  ...
  return (
    <section ref={containerRef} className="relative overflow-hidden bg-white py-32 lg:py-48" data-theme="light">
      <div className="mx-auto max-w-[94rem] px-6 md:px-10 lg:px-10">
        <div className="relative overflow-hidden rounded-[4rem] bg-brand-darker p-12 lg:p-32">
          ...
          <div className="relative z-10 flex flex-col items-center text-center gap-12 lg:gap-16">
            ...
            <div className="flex flex-col gap-8">
              <motion.h2 
                ...
                viewport={{ once: true }}
                className="font-display text-5xl font-medium leading-[1] tracking-tighter text-white sm:text-7xl lg:text-9xl"
              >
                {data.title}
              </motion.h2>
