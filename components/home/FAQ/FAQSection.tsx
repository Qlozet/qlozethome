  ...
  return (
    <section id={data.id} className="bg-white py-24 sm:py-32 scroll-mt-32 overflow-x-hidden">
      <div className="mx-auto w-full max-w-[90rem] px-4 sm:px-6">
        <div className="relative mx-auto w-full max-w-full rounded-[1.5rem] bg-[#3a3a3a] px-6 py-10 text-white shadow-[0_35px_80px_-40px_rgba(58,58,58,0.6)] sm:rounded-[3rem] sm:px-12 sm:py-14 lg:px-16 lg:py-16">
              ...
              {data.items.map((item, index) => {
                ...
                return (
                  <div key={item.question}>
                    ...
                    >
                      <span className="flex-1 text-base font-normal text-white wrap-break-word">
                        {item.question}
                      </span>
